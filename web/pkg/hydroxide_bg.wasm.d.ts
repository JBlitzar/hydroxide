...
export const wasmrenderer_set_sky_hdr: (a: number, b: number, c: number, d: number) => void;
...
export const wasmrenderer_update_mesh: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => void;
